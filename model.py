...
def mobilenet_v1( input_shape, alpha, depth_multiplier, dropout_rate):
    ...
    x = depthwise_conv_block(x, 224, alpha, depth_multiplier, strides=(2, 2))
    x = depthwise_conv_block(x, 384, alpha, depth_multiplier)
    x = depthwise_conv_block(x, 384, alpha, depth_multiplier)
    ...
    x = layers.Conv2D(11, (1, 1), 1, activation='relu', name='logits')(x)
